...
namespace MphRead.Mods.Network
{
    ...
    public static class DemoPlayback
    {
        ...
        public static bool Join(string path, int timeoutMs = 8000)
        {
            ...
            if (_reader == null)
            {
                LastError = $"Cannot open replay: {Launcher.UiText.ReplayStatus(result)}.";
            ...
            if (_reader.Metadata is ReplayMetadata metadata)
            {
                ...
                {
                    LastError = $"Cannot load replay map: {Launcher.UiText.ReplayStatus(LastResult)}.";
                    Stop();
                    return false;
                }
                ...
                if (_pending == null)
                {
                    ...
                    LastError = $"Cannot play replay: {Launcher.UiText.ReplayStatus(LastResult)}.";
                    Stop();
                    return false;
                }
        ...
        public static void PumpFrame()
        {
            ...
            if (_pending == null)
            {
                ...
                if (LastResult != ReplayOpenResult.Success) LastError = $"Replay stopped: {Launcher.UiText.ReplayStatus(LastResult)}.";
            }
        }
